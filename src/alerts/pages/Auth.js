...
const Auth = props => {
    ...
    const authSubmitHandler = async event => {
        ...
        if (isLoginMode) {
            try {
                const responseData = await sendRequest('http://localhost:5000/users/login', 'POST', JSON.stringify({
            ...
            try {
                const responseData = await sendRequest('http://localhost:5000/users/register',  'POST', JSON.stringify({
        ...
        <React.Fragment>
            ...
            <Card className="authentication">
                ...
                <form onSubmit={authSubmitHandler}>
                    ...
                    <Input id="email" element="input" type="email" label="Email" validators={[VALIDATOR_EMAIL()]} errorText="Please enter a valid email address."
